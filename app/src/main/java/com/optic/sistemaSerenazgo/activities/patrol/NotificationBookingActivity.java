...
public class NotificationBookingActivity extends AppCompatActivity {
    ...
    //CONTADOR PARA ACEPTAR O NO UNA SOLICITUD
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //METODO PARA LANZAR UN ACTIVITY CUANDO EL MOVIL ESTA BLOQUEADO , ENCENDIDO .
        getWindow().addFlags(
        ...
        //BOTONES DE ACEPTACION DE SOLICITUDES
        ...
        mListener = mClientBookingProvider.getClientBooking(mExtraIdClient).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    Toasty.error(NotificationBookingActivity.this, "El usuario canceló la solicitud", Toast.LENGTH_LONG).show();
                    if (mHandler != null) mHandler.removeCallbacks(runnable);
                    Intent intent = new Intent(NotificationBookingActivity.this, MapPatrolActivity.class);
    ...
    // ACTUALIZAR CANCELACION EN LA BASE DE DATOS
    ...
    // METODO PARA ACEPTAR UNA SOLICIUD E INICIALIZAR EL ACTIVITY DE LA RUTA TRAZADA
    private void acceptBooking() {
        ...
        Intent intent1 = new Intent(NotificationBookingActivity.this, MapPatrolBookingActivity.class);
    ...
    // CICLO DE VIDA DEL ESTADO DEL RINGTONE
